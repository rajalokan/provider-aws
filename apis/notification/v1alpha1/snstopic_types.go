...
type SNSTopicObservation struct {
	// ARN is the Amazon Resource Name (ARN) specifying the topic. For more information
	// about ARNs and how to use them in Topic, see SNS resource ARN format
	// (https://docs.aws.amazon.com/sns/latest/dg/sns-using-identity-based-policies.html)
	// in the SNS User Guide guide.
